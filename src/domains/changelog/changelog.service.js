...
export class ChangelogService {
  ...
  async buildChangelog(analyzedCommits, insights, version, workingDirAnalysis = null) {
    ...
    // Attribution footer
    changelog += `---\n\n`;
    changelog += `*Generated using [ai-github-changelog-generator-cli-mcp](https://github.com/entro314-labs/AI-github-changelog-generator-cli-mcp) - AI-powered changelog generation for Git repositories*\n`;
