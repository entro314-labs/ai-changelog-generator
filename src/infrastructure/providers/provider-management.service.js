...
export class ProviderManagementService {
  ...
  async switchProvider(providerName, testConnection = false) {
    console.log(
      colors.processingMessage(
        `🔄 Switching to provider: ${colors.highlight(providerName.toUpperCase())}`
      )
    )
  ...
  async configureProvider(providerName = null, testConnection = false, showModels = false) {
    ...
    console.log(
      colors.header(`🔧 Configuring ${colors.highlight(targetProvider.toUpperCase())} Provider:`)
    )
    console.log('')
  ...
  async validateModels(providerName = null, testModels = false, checkCapabilities = false) {
    ...
    console.log(
      colors.header(`🔍 Validating Models for ${colors.highlight(targetProvider.toUpperCase())}:`)
    )
    console.log('')
