...
Provide 3 suggestions.`;
  ...
  async generateChangelogForRecentCommits(count = 10) {
    try {
      console.log(colors.processingMessage(`📝 Generating changelog for recent ${count} commits...`));
      ...
      console.log(colors.successMessage(`✅ Generated changelog for ${recentCommits.length} commits`));
      return result;
  ...
  async generateChangelogForCommits(commitHashes) {
    ...
    try {
      console.log(colors.processingMessage(`📝 Generating changelog for ${commitHashes.length} specific commits...`));
      ...
      console.log(colors.successMessage(`✅ Generated changelog for ${analyzedCommits.length} commits`));
